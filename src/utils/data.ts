...
export const ListOfCars = [{img:audi,name:"Audi"},{img:astonMartin,name:"Aston Martin"},{img:bently,name:"Bently"},{img:bugatti,name:"Bugatti"},{img:cadillac,name:"Cadillac"},
...
export const CarDatabase:any  = {
   "audi": {img:audi,name:"Audi"},
   "Aston Martin":{img:astonMartin,name:"Aston Martin"},
   "Bently":{img:bently,name:"Bently"},
   }